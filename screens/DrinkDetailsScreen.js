...
const DrinkDetailsScreen = ({ route }) => {
  ...
  const [comments, setComments] = useState([
    { id: 1, user: 'Alice Johnson', text: 'Absolutely delicious! A must-try for anyone who loves cocktails.', rating: 5 },
    { id: 2, user: 'Bob Brown', text: 'Good drink, but could use a bit more sweetness.', rating: 4 },
    { id: 3, user: 'Carol White', text: 'Not my favorite, but it’s worth a try.', rating: 3 },
  ]);
      ...
      {drinkDetails && (
        <>
          ...
          <View style={styles.ratingContainer}>
            <Text style={styles.ratingTitle}>Rate this Drink</Text>
